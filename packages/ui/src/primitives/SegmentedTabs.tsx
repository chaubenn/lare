...
/**
 * Sliding-pill segmented control. Measures the active tab and writes left/width
 * onto the pill so the highlight travels instead of popping.
 */
      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={cn(
              "t-tab lare-press inline-flex items-center gap-1.5",
